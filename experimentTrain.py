...
if __name__ == "__main__":
    ...
    if False and ((not args.fullFit) or args.trainValSplit > 0): # currently just ignoring this
        ...
        bootstrap_scanonly_dataset = torch.utils.data.Subset(dataset_scanonly, bootstrap_inds_scanonly)
        fso_batch = len(bootstrap_scanonly_dataset) // num_batches
        fso_data_loader = data.DataLoader(bootstrap_scanonly_dataset, batch_size=fso_batch, shuffle=True, num_workers=0, drop_last=True)
