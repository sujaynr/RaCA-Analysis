...
common_args_base = ['python3', script_path, '--trainValSplit', '0.4', '--encoderModel', 's', '--fullFit', '--epochs', '500', '--noDecoder']

for lr in learning_rates:
    for hl in hidden_layer_sizes:
        for bs in batch_sizes:
            for seed in seeds:
                log_name = f"finalsweepND_lr{lr}_hl{hl}_bs{bs}_seed{seed}"
